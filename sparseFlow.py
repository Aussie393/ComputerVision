...
def get_motion_detections(frame1, 
    ...
    A, prev_points, curr_points = motion_comp(frame1, frame2, num_points=10000, points_to_use=10000, transform_type=transform_type)
...
# get previous frame
prev_frame = cv2.imread(image_paths[0],cv2.COLOR_BGR2RGB)
curr_frame = None

frames = []
for i in range(1, len(image_paths)):
    curr_frame = cv2.imread(image_paths[i],cv2.COLOR_BGR2RGB)
